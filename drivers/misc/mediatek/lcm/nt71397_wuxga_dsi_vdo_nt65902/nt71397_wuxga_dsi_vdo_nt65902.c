...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch					= 5;//20;
    params->dsi.vertical_frontporch 				= 5;//20;/*modified by mtk*/
    params->dsi.vertical_active_line				= FRAME_HEIGHT; 

    params->dsi.horizontal_sync_active				= 4;//20;
    params->dsi.horizontal_backporch				= 58;//80;
    params->dsi.horizontal_frontporch				= 58;//80;
    params->dsi.horizontal_active_pixel 			= FRAME_WIDTH;

	params->dsi.ssc_disable = 0;   //humingzhe  modified for speadtrum 
