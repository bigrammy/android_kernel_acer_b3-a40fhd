...
/* neostra tlc add  start*/
		else if (currSensorName && pinSetIdx == 0 && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5675_MIPI_RAW)))		  
		 {
		...
		mdelay(20);
		         	...
		         	else if ((pinSetIdx==1) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW, currSensorName)))
				{
                 ISP_MCLK1_EN(0);		
				 //disable inactive sensor
...
/* neostra tlc add  end*/
        ...
        if (pinSetIdx == 1 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_SP2509_MIPI_RAW)))
		{
